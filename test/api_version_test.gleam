...
pub fn api_version_serialze_test() {
  ...
  should.equal(serialized, [
    <<18:size(16), 0:size(16), 4:size(16), 0:size(8)>>,
    <<75:size(16), 0:size(16), 0:size(16), 0:size(8)>>,
  ])
  ...
  should.equal(serialized2, <<
    18:size(16), 0:size(16), 4:size(16), 0:size(8), 75:size(16), 0:size(16),
    0:size(16), 0:size(8),
  >>)
}
